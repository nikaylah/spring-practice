...
<body>
    ...
    <form action="savedescription" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="descriptionId"
    ...
    <form action="saveEmployee" method="post">
        ...
        <input type="submit" value="Add Infomation" class="btn btn-success">
    </form>
    
  
    
  <!------ Table to display all Employee info -->
        ...
        <tbody>
            <c:forEach items="${employees}" var="employee">
                <tr>
                    ...
                    <td>${employee.description.street }</td>
                    <td>${employee.description.city }</td>
                    <td>${employee.description.state }</td>
                    <td>${employee.description.country }</td>
